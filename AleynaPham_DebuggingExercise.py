"""
File: AleynaPham_DebuggingExercise.py
Description: Program calculates final prices for specific
products after applying discounts. Try-except block and float()
conversions were added to fix a bug where string price ("500")
caused program to crash during math operation.
"""
...
def main():
    ...
    for product in products:
        try:
            # Change price and discount_rate to float for math operations to succeed.
            ...
            print("Unable to process", product["name"], "-", error)
            print()
